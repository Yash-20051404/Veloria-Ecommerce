...
export default function Dashboard() {
  ...
  useEffect(() => {
    fetch(`${API_URL}/admin/customers`, {
      ...
      .then(res => res.json())
      .then(data => setTotalCustomers(Array.isArray(data.data) ? data.data.length : 0))
  ...
  const statCards = [
    ...
    { label: 'Total Customers', value: totalCustomers === null ? '—' : totalCustomers.toString(), change: '+12.4%', up: true, icon: Users, color: '#ECFDF5', iconColor: '#34D399' },
