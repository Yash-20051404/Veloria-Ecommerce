...
import { useAuthStore } from '@/store/authStore'; // Yeh line upar add karo
...
async function handlePublish() {
    ...
    // ✅ NAYA LOGIC: Frontend ke status ko Backend ke enum se match karna
    // Frontend ke 'Draft' ya 'Archived' ko backend ke 'INACTIVE' me map karo
    ...
    try {
      await addProduct({
        ...
        gemstone,
        occasion,
        status: backendStatus, // ✅ Naya status mapper
        
        // ✅ Seller ID wapas aa gay
