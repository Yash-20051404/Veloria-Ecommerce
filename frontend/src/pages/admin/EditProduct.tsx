            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select value={metal} onChange={e => setMetal(e.target.value)} className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm outline-none focus:border-[#D6B57A]">
                  <option value="">Select metal</option><option>Gold</option><option>Rose Gold</option><option>White Gold</option><option>Silver</option><option>Platinum</option>
                </select>
              </div>
              <div>
                ...
                <select value={purity} onChange={e => setPurity(e.target.value)} className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm outline-none focus:border-[#D6B57A]">
                  <option value="">Select purity</option><option>18 Karat</option><option>22 Karat</option><option>24 Karat</option><option>925 Sterling Silver</option><option>950 Platinum</option>
                </select>
              </div>
              <div>
                ...
                <select value={gemstone} onChange={e => setGemstone(e.target.value)} className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm outline-none focus:border-[#D6B57A]">
                  <option value="">Select gemstone</option><option>Diamond</option><option>Emerald</option><option>Ruby</option><option>Sapphire</option><option>Pearl</option><option>None</option>
                </select>
              </div>
              <div>
                ...
                <select value={occasion} onChange={e => setOccasion(e.target.value)} className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm outline-none focus:border-[#D6B57A]">
                  <option value="">Select occasion</option><option>Wedding</option><option>Engagement</option><option>Anniversary</option><option>Festival</option><option>Daily Wear</option><option>Gift</option>
                </select>
              </div>
              <div>
